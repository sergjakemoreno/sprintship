...
using SprintTek.MultiTenancy.HostDashboard;
...
namespace SprintTek.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(SprintTekDbContext context, SubscriptionPayment subscriptionPayment)
        {
