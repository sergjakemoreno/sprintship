...
using SprintTek.Web.Models.TokenAuth;
using SprintTek.Authorization.Impersonation;
...
using SprintTek.Web.Authentication.External;
...
namespace SprintTek.Web.Controllers
{
    ...
    public class TokenAuthController : SprintTekControllerBase
    {
