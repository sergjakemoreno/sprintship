...
namespace SprintTek.Web.Authentication.JwtBearer
{
    public class SprintTekJwtSecurityTokenHandler : ISecurityTokenValidator
    {
        private readonly JwtSecurityTokenHandler _tokenHandler;

        public SprintTekJwtSecurityTokenHandler()
        {
