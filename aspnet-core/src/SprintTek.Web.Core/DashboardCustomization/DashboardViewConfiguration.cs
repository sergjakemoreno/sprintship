...
namespace SprintTek.Web.DashboardCustomization
{
    public class DashboardViewConfiguration
    {
        ...
        public DashboardViewConfiguration()
        {
            ...
            WidgetFilterViewDefinitions.Add(SprintTekDashboardCustomizationConsts.Filters.FilterDateRangePicker,
                new WidgetFilterViewDefinition(
                    SprintTekDashboardCustomizationConsts.Filters.FilterDateRangePicker,
            ...
            WidgetViewDefinitions.Add(SprintTekDashboardCustomizationConsts.Widgets.Tenant.DailySales,
                new WidgetViewDefinition(
                    SprintTekDashboardCustomizationConsts.Widgets.Tenant.DailySales,
            ...
            WidgetViewDefinitions.Add(SprintTekDashboardCustomizationConsts.Widgets.Tenant.GeneralStats,
                new WidgetViewDefinition(
                    SprintTekDashboardCustomizationConsts.Widgets.Tenant.GeneralStats,
            ...
            WidgetViewDefinitions.Add(SprintTekDashboardCustomizationConsts.Widgets.Tenant.ProfitShare,
                new WidgetViewDefinition(
                    SprintTekDashboardCustomizationConsts.Widgets.Tenant.ProfitShare,
            ...
            WidgetViewDefinitions.Add(SprintTekDashboardCustomizationConsts.Widgets.Tenant.MemberActivity,
                new WidgetViewDefinition(
                    SprintTekDashboardCustomizationConsts.Widgets.Tenant.MemberActivity,
            ...
            WidgetViewDefinitions.Add(SprintTekDashboardCustomizationConsts.Widgets.Tenant.RegionalStats,
                new WidgetViewDefinition(
                    SprintTekDashboardCustomizationConsts.Widgets.Tenant.RegionalStats,
            ...
            WidgetViewDefinitions.Add(SprintTekDashboardCustomizationConsts.Widgets.Tenant.SalesSummary,
                new WidgetViewDefinition(
                    SprintTekDashboardCustomizationConsts.Widgets.Tenant.SalesSummary,
            ...
            WidgetViewDefinitions.Add(SprintTekDashboardCustomizationConsts.Widgets.Tenant.TopStats,
                new WidgetViewDefinition(
                    SprintTekDashboardCustomizationConsts.Widgets.Tenant.TopStats,
            ...
            WidgetViewDefinitions.Add(SprintTekDashboardCustomizationConsts.Widgets.Host.IncomeStatistics,
                new WidgetViewDefinition(
                    SprintTekDashboardCustomizationConsts.Widgets.Host.IncomeStatistics,
            ...
            WidgetViewDefinitions.Add(SprintTekDashboardCustomizationConsts.Widgets.Host.TopStats,
                new WidgetViewDefinition(
                    SprintTekDashboardCustomizationConsts.Widgets.Host.TopStats,
            ...
            WidgetViewDefinitions.Add(SprintTekDashboardCustomizationConsts.Widgets.Host.EditionStatistics,
                new WidgetViewDefinition(
                    SprintTekDashboardCustomizationConsts.Widgets.Host.EditionStatistics,
            ...
            WidgetViewDefinitions.Add(SprintTekDashboardCustomizationConsts.Widgets.Host.SubscriptionExpiringTenants,
                new WidgetViewDefinition(
                    SprintTekDashboardCustomizationConsts.Widgets.Host.SubscriptionExpiringTenants,
            ...
            WidgetViewDefinitions.Add(SprintTekDashboardCustomizationConsts.Widgets.Host.RecentTenants,
                new WidgetViewDefinition(
                    SprintTekDashboardCustomizationConsts.Widgets.Host.RecentTenants,
