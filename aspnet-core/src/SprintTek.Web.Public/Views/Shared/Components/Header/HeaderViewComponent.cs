...
using SprintTek.Url;
using SprintTek.Web.Public.Startup;
using SprintTek.Web.Session;

namespace SprintTek.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : SprintTekViewComponent
    {
