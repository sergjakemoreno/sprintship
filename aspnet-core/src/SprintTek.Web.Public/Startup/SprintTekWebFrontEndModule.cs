...
{
    [DependsOn(
        typeof(SprintTekWebCoreModule)
    )]
    public class SprintTekWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public SprintTekWebFrontEndModule(IWebHostEnvironment env, SprintTekEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(SprintTekWebFrontEndModule).GetAssembly());
        }
    }
}
