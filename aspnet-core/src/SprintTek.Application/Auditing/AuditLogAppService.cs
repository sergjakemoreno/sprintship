...
using SprintTek.Auditing.Exporting;
using SprintTek.Authorization;
using SprintTek.Authorization.Users;
using SprintTek.Dto;
using SprintTek.EntityHistory;
using EntityHistoryHelper = SprintTek.EntityHistory.EntityHistoryHelper;

namespace SprintTek.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : SprintTekAppServiceBase, IAuditLogAppService
    {
