...
using SprintTek.DashboardCustomization.Dto;
using Newtonsoft.Json;

namespace SprintTek.DashboardCustomization
{
    [AbpAuthorize]
    public class DashboardCustomizationAppService : SprintTekAppServiceBase, IDashboardCustomizationAppService
    {
