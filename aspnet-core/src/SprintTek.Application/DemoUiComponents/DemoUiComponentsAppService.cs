...
using SprintTek.DemoUiComponents.Dto;

namespace SprintTek.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : SprintTekAppServiceBase, IDemoUiComponentsAppService
    {
