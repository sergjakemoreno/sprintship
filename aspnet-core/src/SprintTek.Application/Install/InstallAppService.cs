...
using SprintTek.Migrations.Seed;
using SprintTek.Migrations.Seed.Host;
...
namespace SprintTek.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : SprintTekAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<SprintTekDbContext> _migrator;
        ...
        {
            var connectionString = _appConfiguration[$"ConnectionStrings:{SprintTekConsts.ConnectionStringName}"];
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{SprintTekConsts.ConnectionStringName}", constring);
        }
