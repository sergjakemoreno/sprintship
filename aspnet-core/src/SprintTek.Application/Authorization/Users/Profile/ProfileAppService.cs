...
using SprintTek.Authentication.TwoFactor.Google;
using SprintTek.Authorization.Users.Dto;
using SprintTek.Authorization.Users.Profile.Cache;
using SprintTek.Authorization.Users.Profile.Dto;
using SprintTek.Configuration;
using SprintTek.Friendships;
using SprintTek.Gdpr;
using SprintTek.Net.Sms;
using SprintTek.Security;
using SprintTek.Storage;
using SprintTek.Timing;

namespace SprintTek.Authorization.Users.Profile
{
    [AbpAuthorize]
    public class ProfileAppService : SprintTekAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("SprintTek",
