...
using SprintTek.Web.Startup.ExternalLoginInfoProviders;
...
namespace SprintTek.Web.Startup
{
    ...
    public class SprintTekWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public SprintTekWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(SprintTekWebHostModule).GetAssembly());
        }
