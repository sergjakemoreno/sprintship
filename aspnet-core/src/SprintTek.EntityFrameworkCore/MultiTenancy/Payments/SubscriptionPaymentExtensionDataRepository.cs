...
using SprintTek.EntityFrameworkCore.Repositories;

namespace SprintTek.MultiTenancy.Payments
{
    public class SubscriptionPaymentExtensionDataRepository : SprintTekRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<SprintTekDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
