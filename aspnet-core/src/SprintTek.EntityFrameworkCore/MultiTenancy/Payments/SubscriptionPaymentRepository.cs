...
{
    public class SubscriptionPaymentRepository : SprintTekRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<SprintTekDbContext> dbContextProvider)
