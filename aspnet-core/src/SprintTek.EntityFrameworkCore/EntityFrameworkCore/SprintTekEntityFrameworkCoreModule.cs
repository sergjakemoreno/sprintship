...
namespace SprintTek.EntityFrameworkCore
{
    ...
    public class SprintTekEntityFrameworkCoreModule : AbpModule
    {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(SprintTekEntityFrameworkCoreModule).GetAssembly());
        }
