...
using SprintTek.Commands;
using SprintTek.Core.Threading;
using SprintTek.Models.NavigationMenu;
using SprintTek.Services.Navigation;
...
using SprintTek.ApiClient;
using SprintTek.Controls;
using SprintTek.Dto;
using SprintTek.Extensions;
using SprintTek.Localization;
using SprintTek.UI;
using SprintTek.UI.Assets;
using SprintTek.Views;
using DependencyResolver = SprintTek.Core.Dependency.DependencyResolver;
...
namespace SprintTek.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "SprintTek";
