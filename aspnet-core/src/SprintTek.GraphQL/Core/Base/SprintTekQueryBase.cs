...
namespace SprintTek.Core.Base
{
    public abstract class SprintTekQueryBase<TField,TResult> : ITransientDependency
    {
        ...
        protected SprintTekQueryBase(string fieldName,
