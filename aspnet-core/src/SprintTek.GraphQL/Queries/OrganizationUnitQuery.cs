...
using SprintTek.Core.Base;
using SprintTek.Core.Extensions;
using SprintTek.Dto;
using SprintTek.Types;

namespace SprintTek.Queries
{
    public class OrganizationUnitQuery : SprintTekQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
