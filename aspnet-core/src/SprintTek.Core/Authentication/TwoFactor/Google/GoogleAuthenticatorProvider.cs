...
namespace SprintTek.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : SprintTekServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("SprintTek", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
